...
public class AmbulanceSettingActivity extends AppCompatActivity {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("ambulance_no")!=null){
                        mAmbulanceNo=map.get("ambulance_no").toString();
    ...
    private void saveUserInformation() {
        ...
        mAmbulanceDatabase= FirebaseDatabase.getInstance().getReference().child("Users").child("Ambulance").child(userId);
        mAmbulanceDatabase.child("name").setValue(mName);
        mAmbulanceDatabase.child("phone").setValue(mPhone);
        mAmbulanceDatabase.child("ambulance_no").setValue(mAmbulanceNo);
        mAmbulanceDatabase.child("hospital").setValue(mAmbulanceHospital);
        ...
        if(resultUri!=null){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mAmbulanceDatabase.child("profileImageUrl").setValue(downloadUrl.toString());
